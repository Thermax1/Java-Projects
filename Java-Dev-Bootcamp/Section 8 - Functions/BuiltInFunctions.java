public class BuiltInFunctions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(message); //println prints. Duhh.
         ...
         */
        String example = "Java";
        System.out.println(example.length()); //.length for strings counts the length
        ...
        System.out.println(upperCase.toLowerCase()); //converts to lowercase
        ...
        System.out.println(original.replace('a', 'g'));
