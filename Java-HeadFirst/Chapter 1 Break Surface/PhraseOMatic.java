public class PhraseOMatic {
  public static void main (String[] args) {
    ...
    //make three sets of words to choose from.  Add your own (I won't. Long enough lol)
    ...
    String[] wordListTwo = {"loosely coupled", "six sigma", "asynchronus", "event driven", "pub-sub", "IoT", "cloud native", "service oriented", "containerized", "serverless", "microservices", "distributed ledger"};
